...
class PickJobcenter(tk.Toplevel):
    ...
    def __init__(self, controller, parent):
        ...
        # Go button
        btn = BLButton(frame_right, style="Secondary.TButton", text="Jobcenter auswählen",
                         command=self.send_data)
        btn.grid()
    ...
    def send_data(self):
        ...
        if self.selected_jc is None:
            self.error_message.set("Bitte Jobcenter auswählen")
            return
...
class PickTraining(tk.Toplevel):
    ...
    def __init__(self, controller, parent):
        ...
        # header
        lbl_header = ttk.Label(frame_right, text="Auswahl Maßnahme", style="Secondary.Header.TLabel")
        lbl_header.grid(pady=(0, 30))
        ...
        # Go button
        btn = BLButton(frame_right, style="Secondary.TButton", text="Maßnahme auswählen",
                         command=self.send_data)
        btn.grid()
    ...
    def send_data(self):
        ...
        if self.selected_training is None:
            self.error_message.set("Bitte Maßnahme auswählen")
            return
